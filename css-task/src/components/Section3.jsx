...
const Section3 = () => {
  return (
    <div className="p-20 bg-[#0F172A] text-white relative">
      <div className="flex justify-between mb-20">
        <h1 className="text-[56px] font-extrabold">The best of the best</h1>
        <button className="h-16 px-12 py-5 border-2 rounded-lg border-white text-2xl/6 font-bold">Sign up now</button>
      </div>
      ...
      <img className="absolute bottom-0 left-0 w-full px-11 pb-[40px] z-10" src={Blocks} alt="" />
    </div>
  )
}
